...
A test project for trying out cookiecutter-django
...
.. code-block:: bash
    ...
    heroku run python gchiam_cc/manage.py syncdb --noinput --settings=config.settings
    heroku run python gchiam_cc/manage.py migrate --settings=config.settings
    heroku run python gchiam_cc/manage.py collectstatic --settings=config.settings
